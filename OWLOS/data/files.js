...
class FilesList {
    ...
    requestFilesListResult(HTTPResult, sender) {
        if (HTTPResult != "%error") {
    ...
    uploadClick(event) {
        var filesListObject = event.currentTarget.filesList;
        //event.stopPropagation();
    ...
    uploadFileByIndex(index) {
        ...
        request.onloadend = function (oEvent) {
            ...
            if (this.readyState == 4) fileItem.innerHTML += " done";
            else
                if (this.status != 0) {
        ...
        request.onload = function (oEvent) {
            ...
            if (request.status == 200) {
                this.filesListObject.filesListObject.fileItem.innerHTML += "OK";
            }
            else
