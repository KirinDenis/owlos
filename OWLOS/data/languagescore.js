...
var langua = "prepareUnit=підготовка інтерфейсу користувача\n" +
    ...
    "driversporplist=властивості пристроїв\n" +
    ...
    "RESTful=пристрої\n" +  
    "adddriverdigalog=додати новий пристрій до вузлу\n" +
    "drivertype=тип пристрою\n" +
    "driverid=ID пристрою\n" +
    ...
    "addscriptheader=Додавання нового скрипта\n" +
    "addscriptbutton=Додати\n" +
    "addscriptname=Iм'я нового скрипта\n" +
    "language=ukraine\n";
...
var langen = "prepareUnit=prepare UI, please wait...\n" +
    ...
    "closebutton=Close\n" +
    "createscript=Add new script\n" +
    "scripts=Scripts\n" +
    "scriptexecute=Run (F8)\n" +
    "scriptpause=Pause\n" +
    "scriptdelete=Delete\n" +
    "addscriptheader=Adding new script\n" +
    "addscriptbutton=Add\n" +
    "addscriptname=New script name\n" +
    "language=english\n";
