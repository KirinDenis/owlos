        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DHT22temp = table.Column<float>(type: "float", nullable: true),
                    DHT22hum = table.Column<float>(type: "float", nullable: true),
                    DHT22heat = table.Column<float>(type: "float", nullable: true),
                    DHT22c = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    BMP280 = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    BMP280pressure = table.Column<float>(type: "float", nullable: true),
                    BMP280altitude = table.Column<float>(type: "float", nullable: true),
                    BMP280temperature = table.Column<float>(type: "float", nullable: true),
                    ADS1X15 = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    ADS1X15MQ135 = table.Column<float>(type: "float", nullable: true),
                    ADS1X15MQ7 = table.Column<float>(type: "float", nullable: true),
                    ADS1X15Light = table.Column<float>(type: "float", nullable: true),
                    CCS811 = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    CCS811CO2 = table.Column<float>(type: "float", nullable: true),
                    CCS811TVOC = table.Column<float>(type: "float", nullable: true),
                    CCS811resistence = table.Column<float>(type: "float", nullable: true),
                    CCS811temp = table.Column<float>(type: "float", nullable: true)
                },
                constraints: table =>
                {
